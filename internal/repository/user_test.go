...
import (
	...
	test_mock "github.com/nichojovi/rollee-test/internal/utils/test_mock"
...
func expectedGetUserAuthQuery() string {
	return test_mock.NormalizeRegexpQuery("SELECT id, username, password, full_name, email, phone FROM user where username = ? and password = ?")
}
